<template>
  <div class="md:w-custom mx-auto shadow-md mb-10 rounded-lg mt-5">
    <div class="w-full bg-teal h-1 sticky pin-t"></div>
    <img class="w-full h-54 overflow-hidden" src="@/assets/ba.jpg"/>
        <div class="flex justify-between w-full p-5 sticky pin-t bg-white border-grey border-b m-0">
          <div>
    ...
    <div class="w-full bg-white p-5">
      ...
      <h1 class="my-3"><a id="Requirements_18"></a>Requirements</h1>
      <ul>
    ...
    <router-link to="/" tag="button" class="flex-no-shrink bg-grey hover:bg-grey-dark border-grey hover:border-grey-dark text-sm border-4 text-white py-1 px-2 rounded align-middle" type="button">
      Back to Jobs
    </router-link>
    </div>
    </div>
